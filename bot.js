...
client.on("userUpdate", async (oldUser, newUser) => {
  if (oldUser.username !== newUser.username) {
    let tag = " 'ĐÎVΛИ' , 'Divan' , 'Đîvân' "; //tagınız
    let sunucu = "745360624401383466"; //sunucu ID
    let kanal = "751477815802724414" //log kanal id
    let rol = "745589938602377227"; // rol ID
